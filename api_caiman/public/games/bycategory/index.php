 ...
 *  @brief File being the front controller of the API and allowing to process the request to get games by theire category.
 */
...
switch ($requestMethod) {
    case 'GET':
        if (empty($id) || !is_numeric($id)) {
            ...
            $response = $controller->getGameFromCategory($id);
        }
        break;
